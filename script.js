...
chatFab.addEventListener('touchend',e=>{e.preventDefault();chatFab.click();});
chatCloseBtn.addEventListener('click',()=>{chatOpen=false;chatPanelEl.classList.remove('open');});
byId('callLaunchBtn').addEventListener('click',openCallPanel);
...
chatSendBtn.addEventListener('touchend',e=>{e.preventDefault();sendMsg();});
...
byId('callFab').addEventListener('click',openCallPanel);
byId('callFab').addEventListener('touchend',e=>{e.preventDefault();openCallPanel();});
byId('callClose').addEventListener('click',endCall);
byId('callClose').addEventListener('touchend',e=>{e.preventDefault();endCall();});
byId('callEndBtn').addEventListener('click',endCall);
byId('callEndBtn').addEventListener('touchend',e=>{e.preventDefault();endCall();});
...
function openCallPanel(){
  ...
  byId('callTranscript').innerHTML='<p class="call-hint">Stiskni 🎙️ a mluv!</p>';
...
byId('callMicBtn').addEventListener('click',toggleMic);
byId('callMicBtn').addEventListener('touchend',e=>{e.preventDefault();toggleMic();});
...
byId('callMuteBtn').addEventListener('click',()=>{
  callMuted=!callMuted;
